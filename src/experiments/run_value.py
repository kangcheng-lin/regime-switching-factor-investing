...
def main() -> None:
    config = CrossSectionalConfig(
        ...
        output_dir="results/tables/value_full_price_available_universe_modular",
        rebalance_frequency="monthly",
        portfolio_mode="long_only",
        selection_quantile=0.20,
        long_quantile=0.20,   # unused in long_only, kept harmlessly
        short_quantile=0.20,  # unused in long_only
        long_gross=0.50,      # unused in long_only
        short_gross=0.50,     # unused in long_only
        min_ttm_quarters=4,
        price_batch_size=50,
